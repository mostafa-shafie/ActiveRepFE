  ...
  return (
    <div className="min-h-screen bg-[#F2F1EF]">
      ...
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold mb-6 text-center text-[#1F3A93]">
          Dashboards
        </h1>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <Card>
                    ...
                    <CardContent>
                      ...
                      <div className="text-lg text-[#2C3E50]">
                        {coverageData.totalHCPs} HCPs
                      </div>
                      <Progress
                        value={coverageData.totalCoverage}
                        className="mt-2"
                      />
                    </CardContent>
                  </Card>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="text-3xl font-bold text-[#27AE60]">
                        {coverageData.classAVisitedOnce}%
                      </div>
                      <Progress
                        value={coverageData.classAVisitedOnce}
                        className="mt-2"
                      />
                    </CardContent>
                  </Card>
                  <Card>
                    ...
                    <CardContent>
                      <div className="text-3xl font-bold text-[#E74C3C]">
                        {coverageData.classAVisitedAsPerPlan}%
                      </div>
                      <Progress
                        value={coverageData.classAVisitedAsPerPlan}
                        className="mt-2"
                      />
                    </CardContent>
                  </Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <Card>
                    ...
                    <CardContent>
                      <div className="text-3xl font-bold text-[#27AE60]">
                        {detailerUsageData.callsUsingDetailer}%
                      </div>
                      <Progress
                        value={detailerUsageData.callsUsingDetailer}
                        className="mt-2"
                      />
                    </CardContent>
                  </Card>
                  <Card>
                    ...
                    <CardContent>
                      <div className="text-3xl font-bold text-[#3498DB]">
                        {detailerUsageData.callsUsingTargetDetailer}%
                      </div>
                      <Progress
                        value={detailerUsageData.callsUsingTargetDetailer}
                        className="mt-2"
                      />
                    </CardContent>
                  </Card>
